...
/**
 * Package: com.neutrino.dawn.quartz.test Description: Date:  2020/5/21 16:48 Author: kousq Modified
 * By:
 */
public class CronScheduler {
    ...
    public static void main(String[] args) throws SchedulerException, InterruptedException {
        ...
        CronTrigger cronTrigger = TriggerBuilder.newTrigger().withIdentity("cronTrigger").withSchedule(
                CronScheduleBuilder.cronSchedule("0 17 * * * ? ")).build();
        //1.每日10点15分触发      0 15 10 ？* *
        //1.每日10点51分触发      0 17 10 ？* *
